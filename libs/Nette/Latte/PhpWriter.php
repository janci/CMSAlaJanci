...
class NPhpWriter extends NObject
{
	...
	public function escape($s)
	{
		...
		case NLatteCompiler::CONTENT_HTML:
			...
			case NLatteCompiler::CONTEXT_UNQUOTED:
				...
				$quote = $context[0] === NLatteCompiler::CONTEXT_SINGLE_QUOTED ? ', ENT_QUOTES' : '';
				$s = "htmlSpecialChars($s$quote)";
				return $context[0] === NLatteCompiler::CONTEXT_UNQUOTED ? "'\"' . $s . '\"'" : $s;
